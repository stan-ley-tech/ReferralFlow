...
urlpatterns = [
    path("integrations/simulated-hospital/receive/", SimulatedHospitalReceiveView.as_view(), name="simulated-hospital-receive"),
    path("integrations/webhooks/", WebhookReceiveView.as_view(), name="integration-webhook"),
    path("integrations/outbound-requests/", OutboundReferralRequestListView.as_view(), name="outbound-referral-requests"),
